...
): InferableComponentEnhancerWithProps<PropsFromItem<PopulatedType, FullPopulatedType>, { id: PopulatedType[IdKey] }> {
...
function useGetExtended<PopulatedType,
    ...
    IdKey extends SchemaNamespace.StringOrNumberKeys<PopulatedType> & string, Name extends string>(
        model: Model<any, PopulatedType, FullPopulatedType, IdKey, any, any>,
        name: Name
    ): InferableComponentEnhancerWithProps<PropsFromItem<PopulatedType, FullPopulatedType, Name>, { id: PopulatedType[IdKey] }> {
    return (ReactComponent): any => {
        const ObjectRaising: React.FunctionComponent<GetProps<typeof ReactComponent> & {
            id: PopulatedType[IdKey]
        }
...
function useGetExtendedRenamed<PopulatedType,
    ...
    ): InferableComponentEnhancerWithProps<PropsFromItem<PopulatedType, FullPopulatedType, Name>, Record<idPropName, PopulatedType[IdKey]>> {
    return (ReactComponent): any => {
...
export default function connectGetById(
    ...
    name?: string,
    idPropName?: string
): InferableComponentEnhancerWithProps<PropsFromItem<any, any, any>, any> {
